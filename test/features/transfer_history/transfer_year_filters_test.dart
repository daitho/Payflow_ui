...
void main() {
  testWidgets(
    'year and status are adjacent and changes preserve other filters',
    (tester) async {
      ...
      final page = TransferHistoryPageModel(
        items: [],
        beneficiaries: [
          const TransferHistoryBeneficiaryModel('alice', 'Alice'),
        ],
        ...
        MaterialApp(
          ...
          home: Scaffold(
            body: StatefulBuilder(
              builder: (context, setState) => TransferHistoryFilters(
                filter: filter,
                page: page,
                enabled: true,
