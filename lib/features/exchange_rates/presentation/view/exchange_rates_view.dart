...
class ExchangeRatesView
  ...
  @override
  State<ExchangeRatesView>
  createState() =>
      _ExchangeRatesViewState();
}

class _ExchangeRatesViewState
    extends State<ExchangeRatesView> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance
        ...
        final ExchangeRatesViewModel
        viewModel =
        context.read<
            ExchangeRatesViewModel>();

        if (viewModel.status ==
            ExchangeRatesViewStatus
                .initial) {
          viewModel.load();
        }
      },
