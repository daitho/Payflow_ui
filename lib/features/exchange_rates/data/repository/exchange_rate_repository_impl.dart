...
final class ExchangeRateRepositoryImpl implements ExchangeRateRepository {
  ...
  ExchangeRateRepositoryImpl(this._apiService);

  @override
  Future<List<AvailableExchangeRateModel>> getAvailableExchangeRates() async {
    final dtos = await _apiService.getAvailableExchangeRates();
