...
class _SplashViewState
  ...
  _initializeApplication() async {
    ...
    final SplashDestination?
    destination =
    await viewModel.initialize(
      biometricReason:
      l10n.unlockPayFlowBiometricReason,
    );
