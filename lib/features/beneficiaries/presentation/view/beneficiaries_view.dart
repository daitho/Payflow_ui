...
class BeneficiariesView extends StatelessWidget {
  ...
  Future<void> _open(BuildContext context, {String? id}) async {
    ...
    final saved = await context.push<BeneficiaryContact>(
      id == null
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return InkWell(
                      ...
                      child: Padding(
                        ...
                        child: Row(
                          children: [
                            BeneficiaryAvatar(contact: contact),
                            ...
                            if (!selectionMode)
                              IconButton(
                                tooltip:
                                    '${l10n.contactEdit}: ${contact.fullName}',
