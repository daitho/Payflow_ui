...
class TransferDetailView extends StatelessWidget {
  ...
  Future<void> _receipt(BuildContext context, TransferDetailViewModel vm) async {
    final l10n = AppLocalizations.of(context);
    final bytes = await vm.exportReceipt(Localizations.localeOf(context).toLanguageTag());
    if (!context.mounted) return;
    if (bytes != null) {
      await Navigator.of(context).push(MaterialPageRoute<void>(builder: (_) =>
        TransferPdfView(bytes: bytes, title: l10n.transferReceiptAction,
      ...
      body: SafeArea(child: RefreshIndicator(
        ...
        child: ListView(
          ...
          children: [
            ...
            if (vm.error != null) Column(children: [
              Text(transferError(l10n, vm.error!)),
              TextButton(onPressed: vm.isLoading ? null : vm.load, child: Text(l10n.retry)),
            ]),
            if (detail != null) ...[
              ...
              TransferDetailField(label: l10n.transferTotalAmount,
