...
class TransferHistorySummary extends StatelessWidget {
  ...
  const TransferHistorySummary({super.key, required this.page,
    required this.busy, required this.exporting, required this.onExport});
        ...
        child: Row(crossAxisAlignment: CrossAxisAlignment.center, children: [
          Expanded(child: ConstrainedBox(
            ...
            child: SingleChildScrollView(child: Column(
              ...
              Text(l10n.transferCountLabel,
                style: const TextStyle(color: Color(0xFF948C88), fontSize: 12)),
              const SizedBox(height: 4),
              if (page != null) ...[
                Text('${page!.transactionCount}',
                  style: const TextStyle(fontWeight: FontWeight.w600)),
                Text(l10n.transferSentTotalLabel,
                  style: const TextStyle(color: Color(0xFF948C88), fontSize: 11)),
                ...page!.sentTotals.map((total) => Text(
                  transferMoney(context, total.amount, total.currencyCode),
                  style: const TextStyle(color: Color(0xFF008B80),
